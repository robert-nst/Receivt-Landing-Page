            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-4">
                            Launch digital services under your own brand.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <PrivacyPolicyDialog><span className="hover:underline cursor-pointer">Privacy Policy</span></PrivacyPolicyDialog>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <div className="flex space-x-4 mt-4 md:mt-0">
                                <a href="https://www.linkedin.com/company/receivt/" target='_blank' className="text-gray-400 hover:text-white transition">
                                    <span className="sr-only">LinkedIn</span>
                                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                                    </svg>
                                </a>
                                <a href="https://www.instagram.com/receivt/" target='_blank' className="text-gray-400 hover:text-white transition">
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm">
                        © {new Date().getFullYear()} Receivt. All rights reserved.
                    </p>
